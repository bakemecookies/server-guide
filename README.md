...
1. Install the MySQL APT repository: `wget https://dev.mysql.com/get/mysql-apt-config_0.8.5-1_all.deb`, then `sudo dpkg --install mysql-apt-config_0.8.5-1_all.deb`, then `sudo apt-get update`.
